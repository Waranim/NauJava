...
class BookRepositoryTest {
    ...
    @Test
    void findByGenreAndAvailableForOnline_ShouldReturnFilteredBooks() {
        String genre = "Фэнтези";
        BookEntity book1 = createTestBook(genre);
        BookEntity book2 = createTestBook("Детектив");
        bookRepository.saveAll(List.of(book1, book2));

        List<BookEntity> result = bookRepository.findByGenreAndIsAvailableForOnline(genre, true);
